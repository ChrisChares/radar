...
// Expecta+OCMock
#define COCOAPODS_POD_AVAILABLE_Expecta_OCMock
#define COCOAPODS_VERSION_MAJOR_Expecta_OCMock 1
#define COCOAPODS_VERSION_MINOR_Expecta_OCMock 0
#define COCOAPODS_VERSION_PATCH_Expecta_OCMock 0
